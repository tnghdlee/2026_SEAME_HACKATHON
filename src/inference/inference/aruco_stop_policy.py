...
배선: inference_node.py 가 image_callback(카메라 프레임 rate)에서 update(present) 를
  호출하고, control_tick 에서 is_stopped 이면 throttle 을 0.0 으로 덮어쓴다. present 는
  aruco_detect.obstacle_present() 의 3중 게이팅 결과.
"""
